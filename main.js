...
function getData(element) {
    ...
    if (element == "f1") {
        ...
        if (datas.id.length <= 24) {
            ...
            console.log("ERRO: FOI IDENTIFICADO ID QUE NÃO ATENDE AO CRITÉRIO DE MÁXIMO 24 CARACTERES, ANALISE E TENTE NOVAMENTE!");
        }
    }
    if (element == "f2") {
        ...
        if (file) {
            ...
            reader.onload = function (e) {
                ...
                for (var c = 1; c < firstColumnData.length; c++) {
                    ...
                    if (thirdColumnData[c].length > 24) {
                        alert("ERRO: FOI IDENTIFICADO ID QUE NÃO ATENDE AO CRITÉRIO DE MÁXIMO 24 CARACTERES, ANALISE E TENTE NOVAMENTE:" + thirdColumnData[c]);
                        console.log("ERRO: FOI IDENTIFICADO ID QUE NÃO ATENDE AO CRITÉRIO DE 24 CARACTERES, ANALISE E TENTE NOVAMENTE:" + thirdColumnData[c]);
                        break;
                    } else {
